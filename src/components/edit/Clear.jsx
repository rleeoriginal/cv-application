    ...
    return (
        <>
            <div class="card m-3 shadow">
                <div class="card-body">
                    <div class="" >
                        <button type="button" class="btn btn-outline-danger w-100 d-flex justify-content-center align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#clearConfirmation">
